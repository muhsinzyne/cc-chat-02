		...
		<div id="file-share-location" style="display: none;">
			<div class="file-share-input-container">
				<div id="file-share-info">
					...
					<div id="file-share-details">'.sprintf($LNG['plugin_file_share_up_to'], $pluginsSettings['file_share_max_files'], fsize($pluginsSettings['file_share_max_upload_size']), fsize($pluginsSettings['file_share_max_size'])).'</div>
				</div>
